...
void setup_scr_screen_6(lv_ui *ui)
{
    ...
    lv_obj_set_size(ui->screen_6, 720, 720);
    ...
    lv_label_set_text(ui->screen_6_btn_1_label, "Button");
    ...
    lv_obj_set_pos(ui->screen_6_btn_1, 54, 490);
    lv_obj_set_size(ui->screen_6_btn_1, 100, 50);
    ...
    lv_label_set_text(ui->screen_6_btn_2_label, "Button");
    ...
    lv_obj_set_pos(ui->screen_6_btn_2, 224, 490);
    lv_obj_set_size(ui->screen_6_btn_2, 100, 50);
    ...
    lv_label_set_text(ui->screen_6_btn_3_label, "Button");
    ...
    lv_obj_set_pos(ui->screen_6_btn_3, 457, 490);
    lv_obj_set_size(ui->screen_6_btn_3, 100, 50);
    ...
    lv_obj_set_style_bg_color(ui->screen_6_btn_3, lv_color_hex(0x2195f6), LV_PART_MAIN|LV_STATE_DEFAULT);

...
void setup_scr_SensorSet(lv_ui *ui)
{
    ...
    ui->SensorSet_tabview_1 = lv_tabview_create(ui->SensorSet, LV_DIR_TOP, 70);
    ...
    lv_style_set_bg_color(&style_SensorSet_tabview_1_extra_btnm_main_default, lv_color_hex(0x4f3f3f));
    ...
    lv_obj_set_style_text_font(ui->SensorSet_label_5, &lv_font_ZiTiQuanWeiJunHeiW22_24, LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    lv_obj_set_style_text_font(ui->SensorSet_label_6, &lv_font_montserratMedium_16, LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    lv_obj_set_style_text_font(ui->SensorSet_label_7, &lv_font_montserratMedium_16, LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    lv_obj_set_style_text_font(ui->SensorSet_label_10, &lv_font_ZiTiQuanWeiJunHeiW22_24, LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    lv_obj_set_pos(ui->SensorSet_cont_5, 31, 54);
    ...
    lv_obj_set_style_text_font(ui->SensorSet_label_9, &lv_font_montserratMedium_16, LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    lv_obj_set_style_text_font(ui->SensorSet_label_8, &lv_font_montserratMedium_16, LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    lv_obj_align(ui->SensorSet_btn_1_label, LV_ALIGN_CENTER, 0, 0);
    lv_obj_set_style_pad_all(ui->SensorSet_btn_1, 0, LV_STATE_DEFAULT);
    lv_obj_set_width(ui->SensorSet_btn_1_label, LV_PCT(100));
    lv_obj_set_pos(ui->SensorSet_btn_1, 11, 7);
    lv_obj_set_size(ui->SensorSet_btn_1, 206, 50);
    ...
    lv_obj_set_style_text_font(ui->SensorSet_btn_1, &lv_font_ZiTiQuanWeiJunHeiW22_30, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_text_opa(ui->SensorSet_btn_1, 255, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_text_align(ui->SensorSet_btn_1, LV_TEXT_ALIGN_CENTER, LV_PART_MAIN|LV_STATE_DEFAULT);

...
void setup_scr_SensorSet(lv_ui *ui)
{
    ...
    lv_obj_set_pos(ui->SensorSet_btn_1, 40, 25);
    lv_obj_set_size(ui->SensorSet_btn_1, 186, 35);
    ...
    lv_obj_set_pos(ui->SensorSet_btn_13, 4, 4);
    lv_obj_set_size(ui->SensorSet_btn_13, 229, 82);

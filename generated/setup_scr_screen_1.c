...
void setup_scr_screen_1(lv_ui *ui)
{
    ...
    ui->screen_1_list_1_item0 = lv_list_add_btn(ui->screen_1_list_1, LV_SYMBOL_WIFI, "网络设置");
    ui->screen_1_list_1_item1 = lv_list_add_btn(ui->screen_1_list_1, LV_SYMBOL_LOOP, "显示设置");
    ui->screen_1_list_1_item2 = lv_list_add_btn(ui->screen_1_list_1, LV_SYMBOL_SAVE, "开关配置");
    ui->screen_1_list_1_item3 = lv_list_add_btn(ui->screen_1_list_1, LV_SYMBOL_SAVE, "传感器配置");
    ui->screen_1_list_1_item4 = lv_list_add_btn(ui->screen_1_list_1, LV_SYMBOL_SAVE, "设备重启");
    ui->screen_1_list_1_item5 = lv_list_add_btn(ui->screen_1_list_1, LV_SYMBOL_SAVE, "恢复出厂");
    ui->screen_1_list_1_item6 = lv_list_add_btn(ui->screen_1_list_1, LV_SYMBOL_SAVE, "关于产品");
    lv_obj_set_pos(ui->screen_1_list_1, 0, 71);
    lv_obj_set_size(ui->screen_1_list_1, 720, 650);
    ...
    lv_style_set_pad_top(&style_screen_1_list_1_main_main_default, 20);
    ...
    lv_style_set_bg_color(&style_screen_1_list_1_main_main_default, lv_color_hex(0x000000));
    ...
    lv_style_set_pad_left(&style_screen_1_list_1_extra_btns_main_default, 30);
    lv_style_set_pad_right(&style_screen_1_list_1_extra_btns_main_default, 10);
    lv_style_set_pad_bottom(&style_screen_1_list_1_extra_btns_main_default, 20);
    lv_style_set_border_width(&style_screen_1_list_1_extra_btns_main_default, 2);
    lv_style_set_border_opa(&style_screen_1_list_1_extra_btns_main_default, 255);
    lv_style_set_border_color(&style_screen_1_list_1_extra_btns_main_default, lv_color_hex(0x151313));
    lv_style_set_border_side(&style_screen_1_list_1_extra_btns_main_default, LV_BORDER_SIDE_BOTTOM);
    lv_style_set_text_color(&style_screen_1_list_1_extra_btns_main_default, lv_color_hex(0xffffff));
    lv_style_set_text_font(&style_screen_1_list_1_extra_btns_main_default, &lv_font_ZiTiQuanWeiJunHeiW22_30);
    ...
    lv_style_set_bg_color(&style_screen_1_list_1_extra_btns_main_default, lv_color_hex(0x000000));
    ...
    lv_style_set_pad_left(&style_screen_1_list_1_extra_texts_main_default, 30);
    ...
    lv_style_set_border_width(&style_screen_1_list_1_extra_texts_main_default, 5);
    lv_style_set_border_opa(&style_screen_1_list_1_extra_texts_main_default, 255);
    lv_style_set_border_color(&style_screen_1_list_1_extra_texts_main_default, lv_color_hex(0xfafafa));
    lv_style_set_border_side(&style_screen_1_list_1_extra_texts_main_default, LV_BORDER_SIDE_FULL);
    lv_style_set_text_color(&style_screen_1_list_1_extra_texts_main_default, lv_color_hex(0xffffff));
    lv_style_set_text_font(&style_screen_1_list_1_extra_texts_main_default, &lv_font_ZiTiQuanWeiJunHeiW22_30);
    lv_style_set_text_opa(&style_screen_1_list_1_extra_texts_main_default, 255);
    lv_style_set_radius(&style_screen_1_list_1_extra_texts_main_default, 5);
    ...
    lv_label_set_text(ui->screen_1_btn_1_label, "<  关于产品");

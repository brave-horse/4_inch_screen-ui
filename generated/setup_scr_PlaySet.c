...
void setup_scr_PlaySet(lv_ui *ui)
{
    ...
    lv_obj_set_style_text_font(ui->PlaySet_btn_1, &lv_font_ZiTiQuanWeiJunHeiW22_30, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_text_opa(ui->PlaySet_btn_1, 255, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_text_align(ui->PlaySet_btn_1, LV_TEXT_ALIGN_CENTER, LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    lv_style_set_text_font(&style_PlaySet_List_extra_btns_main_default, &lv_font_ZiTiQuanWeiJunHeiW22_30);
    ...
    lv_style_set_text_font(&style_PlaySet_List_extra_texts_main_default, &lv_font_montserratMedium_12);

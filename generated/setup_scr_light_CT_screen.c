...
void setup_scr_light_CT_screen(lv_ui *ui)
{
    ...
    lv_obj_set_pos(ui->light_CT_screen_cont_1, 0, 75);
    ...
    lv_obj_set_pos(ui->light_CT_screen_label_2, 259, 554);
    ...
    lv_obj_set_pos(ui->light_CT_screen_slider_2, -223, 616);
    ...
    lv_obj_set_style_bg_img_src(ui->light_CT_screen_slider_2, &_ct_bar_600x70, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_bg_img_opa(ui->light_CT_screen_slider_2, 255, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_bg_img_recolor_opa(ui->light_CT_screen_slider_2, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    lv_obj_set_pos(ui->light_CT_screen_slider_1, -223, 447);
    ...
    lv_obj_set_pos(ui->light_CT_screen_label_1, 239, 394);
    ...
    lv_img_set_src(ui->light_CT_screen_dev_shell_img, &_dev_shell_alpha_100x100);
    lv_img_set_pivot(ui->light_CT_screen_dev_shell_img, 50,50);
    lv_img_set_angle(ui->light_CT_screen_dev_shell_img, 0);
    lv_obj_set_pos(ui->light_CT_screen_dev_shell_img, 269, 101);
    lv_obj_set_size(ui->light_CT_screen_dev_shell_img, 100, 100);
    ...
    //Write codes light_CT_screen_dev_white_lid
    ui->light_CT_screen_dev_white_lid = lv_img_create(ui->light_CT_screen);
    lv_obj_add_flag(ui->light_CT_screen_dev_white_lid, LV_OBJ_FLAG_CLICKABLE);
    lv_img_set_src(ui->light_CT_screen_dev_white_lid, &_dev_white_lid_alpha_174x27);
    lv_img_set_pivot(ui->light_CT_screen_dev_white_lid, 50,50);
    lv_img_set_angle(ui->light_CT_screen_dev_white_lid, 0);
    lv_obj_set_pos(ui->light_CT_screen_dev_white_lid, 232, 181);
    lv_obj_set_size(ui->light_CT_screen_dev_white_lid, 174, 27);

    //Write style for light_CT_screen_dev_white_lid, Part: LV_PART_MAIN, State: LV_STATE_DEFAULT.
    lv_obj_set_style_img_recolor_opa(ui->light_CT_screen_dev_white_lid, 176, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_img_recolor(ui->light_CT_screen_dev_white_lid, lv_color_hex(0x0a0a0a), LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_img_opa(ui->light_CT_screen_dev_white_lid, 255, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_radius(ui->light_CT_screen_dev_white_lid, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_clip_corner(ui->light_CT_screen_dev_white_lid, true, LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    lv_img_set_src(ui->light_CT_screen_dev_orange_img, &_dev_orange_alpha_280x80);
    lv_img_set_pivot(ui->light_CT_screen_dev_orange_img, 50,50);
    lv_img_set_angle(ui->light_CT_screen_dev_orange_img, 10);
    lv_obj_set_pos(ui->light_CT_screen_dev_orange_img, 180, 185);
    lv_obj_set_size(ui->light_CT_screen_dev_orange_img, 280, 80);
    ...
    lv_img_set_src(ui->light_CT_screen_dev_white_img, &_dev_white_alpha_280x80);
    lv_img_set_pivot(ui->light_CT_screen_dev_white_img, 50,50);
    lv_img_set_angle(ui->light_CT_screen_dev_white_img, 10);
    lv_obj_set_pos(ui->light_CT_screen_dev_white_img, 180, 185);
    lv_obj_set_size(ui->light_CT_screen_dev_white_img, 280, 80);
    ...
    lv_imgbtn_set_src(ui->light_CT_screen_imgbtn_1, LV_IMGBTN_STATE_RELEASED, NULL, &_scene_btn_alpha_48x48, NULL);
    lv_imgbtn_set_src(ui->light_CT_screen_imgbtn_1, LV_IMGBTN_STATE_CHECKED_RELEASED, NULL, &_scene_btn_close_alpha_48x48, NULL);
    ...
    lv_obj_set_pos(ui->light_CT_screen_imgbtn_1, 652, 100);
    ...
    lv_imgbtn_set_src(ui->light_CT_screen_on_off_2_img, LV_IMGBTN_STATE_RELEASED, NULL, &_onoff_off_alpha_48x48, NULL);
    lv_imgbtn_set_src(ui->light_CT_screen_on_off_2_img, LV_IMGBTN_STATE_CHECKED_RELEASED, NULL, &_onoff_on_alpha_48x48, NULL);

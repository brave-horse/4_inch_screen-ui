...
void setup_scr_screen_2(lv_ui *ui)
{
    ...
    lv_obj_set_size(ui->screen_2, 720, 720);
    ...
    ui->screen_2_tabview_1 = lv_tabview_create(ui->screen_2, LV_DIR_TOP, 85);
    lv_obj_set_pos(ui->screen_2_tabview_1, -1, -1);
    lv_obj_set_size(ui->screen_2_tabview_1, 720, 720);
    lv_obj_set_scrollbar_mode(ui->screen_2_tabview_1, LV_SCROLLBAR_MODE_ON);
    ...
    lv_obj_set_style_text_font(ui->screen_2_tabview_1, &lv_font_ZiTiQuanWeiJunHeiW22_12, LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    lv_style_set_bg_color(&style_screen_2_tabview_1_extra_btnm_main_default, lv_color_hex(0x201b1b));
    ...
    lv_style_set_text_font(&style_screen_2_tabview_1_extra_btnm_items_default, &lv_font_ZiTiQuanWeiJunHeiW22_12);
    ...
    lv_style_set_border_width(&style_screen_2_tabview_1_extra_btnm_items_checked, 0);
    lv_style_set_radius(&style_screen_2_tabview_1_extra_btnm_items_checked, 0);
    lv_style_set_bg_opa(&style_screen_2_tabview_1_extra_btnm_items_checked, 255);
    lv_style_set_bg_color(&style_screen_2_tabview_1_extra_btnm_items_checked, lv_color_hex(0x201b1b));
    ...
    //Write codes
    ui->screen_2_tabview_1_tab_1 = lv_tabview_add_tab(ui->screen_2_tabview_1,"");
    ...
    ui->screen_2_btn_10 = lv_btn_create(ui->screen_2_tabview_1_tab_1);
    lv_obj_add_flag(ui->screen_2_btn_10, LV_OBJ_FLAG_CHECKABLE);
    ui->screen_2_btn_10_label = lv_label_create(ui->screen_2_btn_10);
    lv_label_set_text(ui->screen_2_btn_10_label, "按键1");
    lv_label_set_long_mode(ui->screen_2_btn_10_label, LV_LABEL_LONG_CLIP);
    ...
    lv_obj_set_pos(ui->screen_2_btn_10, 14, 17);
    lv_obj_set_size(ui->screen_2_btn_10, 300, 150);

    //Write style for screen_2_btn_10, Part: LV_PART_MAIN, State: LV_STATE_DEFAULT.
    lv_obj_set_style_bg_opa(ui->screen_2_btn_10, 162, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_bg_color(ui->screen_2_btn_10, lv_color_hex(0x3a5789), LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    lv_obj_set_style_text_font(ui->screen_2_btn_10, &lv_font_ZiTiQuanWeiJunHeiW22_30, LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    ui->screen_2_btn_9 = lv_btn_create(ui->screen_2_tabview_1_tab_1);
    lv_obj_add_flag(ui->screen_2_btn_9, LV_OBJ_FLAG_CHECKABLE);
    ui->screen_2_btn_9_label = lv_label_create(ui->screen_2_btn_9);
    lv_label_set_text(ui->screen_2_btn_9_label, "按键1");
    lv_label_set_long_mode(ui->screen_2_btn_9_label, LV_LABEL_LONG_CLIP);
    ...
    lv_obj_set_pos(ui->screen_2_btn_9, 376, 17);
    lv_obj_set_size(ui->screen_2_btn_9, 300, 150);

    //Write style for screen_2_btn_9, Part: LV_PART_MAIN, State: LV_STATE_DEFAULT.
    lv_obj_set_style_bg_opa(ui->screen_2_btn_9, 162, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_bg_color(ui->screen_2_btn_9, lv_color_hex(0x3a5789), LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    lv_obj_set_style_text_font(ui->screen_2_btn_9, &lv_font_ZiTiQuanWeiJunHeiW22_30, LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    ui->screen_2_btn_8 = lv_btn_create(ui->screen_2_tabview_1_tab_1);
    lv_obj_add_flag(ui->screen_2_btn_8, LV_OBJ_FLAG_CHECKABLE);
    ui->screen_2_btn_8_label = lv_label_create(ui->screen_2_btn_8);
    lv_label_set_text(ui->screen_2_btn_8_label, "按键1");
    lv_label_set_long_mode(ui->screen_2_btn_8_label, LV_LABEL_LONG_CLIP);
    ...
    lv_obj_set_pos(ui->screen_2_btn_8, 376, 211);
    lv_obj_set_size(ui->screen_2_btn_8, 300, 150);

    //Write style for screen_2_btn_8, Part: LV_PART_MAIN, State: LV_STATE_DEFAULT.
    lv_obj_set_style_bg_opa(ui->screen_2_btn_8, 162, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_bg_color(ui->screen_2_btn_8, lv_color_hex(0x3a5789), LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    lv_obj_set_style_text_font(ui->screen_2_btn_8, &lv_font_ZiTiQuanWeiJunHeiW22_30, LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    ui->screen_2_btn_7 = lv_btn_create(ui->screen_2_tabview_1_tab_1);
    lv_obj_add_flag(ui->screen_2_btn_7, LV_OBJ_FLAG_CHECKABLE);
    ui->screen_2_btn_7_label = lv_label_create(ui->screen_2_btn_7);
    lv_label_set_text(ui->screen_2_btn_7_label, "按键1");
    ...
    lv_obj_set_pos(ui->screen_2_btn_7, 14, 212);
    lv_obj_set_size(ui->screen_2_btn_7, 300, 150);

    //Write style for screen_2_btn_7, Part: LV_PART_MAIN, State: LV_STATE_DEFAULT.
    lv_obj_set_style_bg_opa(ui->screen_2_btn_7, 162, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_bg_color(ui->screen_2_btn_7, lv_color_hex(0x3a5789), LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    lv_obj_set_style_text_font(ui->screen_2_btn_7, &lv_font_ZiTiQuanWeiJunHeiW22_30, LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    ui->screen_2_btn_6 = lv_btn_create(ui->screen_2_tabview_1_tab_1);
    lv_obj_add_flag(ui->screen_2_btn_6, LV_OBJ_FLAG_CHECKABLE);
    ui->screen_2_btn_6_label = lv_label_create(ui->screen_2_btn_6);
    lv_label_set_text(ui->screen_2_btn_6_label, "按键1");
    ...
    lv_obj_set_pos(ui->screen_2_btn_6, 14, 602);
    lv_obj_set_size(ui->screen_2_btn_6, 300, 150);

    //Write style for screen_2_btn_6, Part: LV_PART_MAIN, State: LV_STATE_DEFAULT.
    lv_obj_set_style_bg_opa(ui->screen_2_btn_6, 162, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_bg_color(ui->screen_2_btn_6, lv_color_hex(0x3a5789), LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    lv_obj_set_style_text_font(ui->screen_2_btn_6, &lv_font_ZiTiQuanWeiJunHeiW22_30, LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    ui->screen_2_btn_5 = lv_btn_create(ui->screen_2_tabview_1_tab_1);
    lv_obj_add_flag(ui->screen_2_btn_5, LV_OBJ_FLAG_CHECKABLE);
    ui->screen_2_btn_5_label = lv_label_create(ui->screen_2_btn_5);
    lv_label_set_text(ui->screen_2_btn_5_label, "按键1");
    ...
    lv_obj_set_pos(ui->screen_2_btn_5, 14, 407);
    lv_obj_set_size(ui->screen_2_btn_5, 300, 150);

    //Write style for screen_2_btn_5, Part: LV_PART_MAIN, State: LV_STATE_DEFAULT.
    lv_obj_set_style_bg_opa(ui->screen_2_btn_5, 162, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_bg_color(ui->screen_2_btn_5, lv_color_hex(0x3a5789), LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    lv_obj_set_style_text_font(ui->screen_2_btn_5, &lv_font_ZiTiQuanWeiJunHeiW22_30, LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    ui->screen_2_btn_4 = lv_btn_create(ui->screen_2_tabview_1_tab_1);
    lv_obj_add_flag(ui->screen_2_btn_4, LV_OBJ_FLAG_CHECKABLE);
    ui->screen_2_btn_4_label = lv_label_create(ui->screen_2_btn_4);
    lv_label_set_text(ui->screen_2_btn_4_label, "按键1");
    ...
    lv_obj_set_pos(ui->screen_2_btn_4, 376, 599);
    lv_obj_set_size(ui->screen_2_btn_4, 300, 150);

    //Write style for screen_2_btn_4, Part: LV_PART_MAIN, State: LV_STATE_DEFAULT.
    lv_obj_set_style_bg_opa(ui->screen_2_btn_4, 162, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_bg_color(ui->screen_2_btn_4, lv_color_hex(0x3a5789), LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    lv_obj_set_style_text_font(ui->screen_2_btn_4, &lv_font_ZiTiQuanWeiJunHeiW22_30, LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    ui->screen_2_btn_3 = lv_btn_create(ui->screen_2_tabview_1_tab_1);
    lv_obj_add_flag(ui->screen_2_btn_3, LV_OBJ_FLAG_CHECKABLE);
    ui->screen_2_btn_3_label = lv_label_create(ui->screen_2_btn_3);
    lv_label_set_text(ui->screen_2_btn_3_label, "按键1");
    ...
    lv_obj_set_pos(ui->screen_2_btn_3, 376, 405);
    lv_obj_set_size(ui->screen_2_btn_3, 300, 150);

    //Write style for screen_2_btn_3, Part: LV_PART_MAIN, State: LV_STATE_DEFAULT.
    lv_obj_set_style_bg_opa(ui->screen_2_btn_3, 162, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_bg_color(ui->screen_2_btn_3, lv_color_hex(0x3a5789), LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    lv_obj_set_style_text_font(ui->screen_2_btn_3, &lv_font_ZiTiQuanWeiJunHeiW22_30, LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    ui->screen_2_btn_2 = lv_btn_create(ui->screen_2_tabview_1_tab_1);
    lv_obj_add_flag(ui->screen_2_btn_2, LV_OBJ_FLAG_CHECKABLE);
    ui->screen_2_btn_2_label = lv_label_create(ui->screen_2_btn_2);
    lv_label_set_text(ui->screen_2_btn_2_label, "按键1");
    ...
    lv_obj_set_pos(ui->screen_2_btn_2, 14, 797);
    lv_obj_set_size(ui->screen_2_btn_2, 300, 150);

    //Write style for screen_2_btn_2, Part: LV_PART_MAIN, State: LV_STATE_DEFAULT.
    lv_obj_set_style_bg_opa(ui->screen_2_btn_2, 162, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_bg_color(ui->screen_2_btn_2, lv_color_hex(0x3a5789), LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    lv_obj_set_style_text_font(ui->screen_2_btn_2, &lv_font_ZiTiQuanWeiJunHeiW22_30, LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    lv_obj_set_pos(ui->screen_2_btn_1, 376, 793);
    lv_obj_set_size(ui->screen_2_btn_1, 300, 150);

    //Write style for screen_2_btn_1, Part: LV_PART_MAIN, State: LV_STATE_DEFAULT.
    lv_obj_set_style_bg_opa(ui->screen_2_btn_1, 162, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_bg_color(ui->screen_2_btn_1, lv_color_hex(0x3a5789), LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    lv_obj_set_style_text_font(ui->screen_2_btn_1, &lv_font_ZiTiQuanWeiJunHeiW22_30, LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    lv_label_set_text(ui->screen_2_label_1, "灯光情景");
    lv_label_set_long_mode(ui->screen_2_label_1, LV_LABEL_LONG_WRAP);
    lv_obj_set_pos(ui->screen_2_label_1, 20, 20);
    lv_obj_set_size(ui->screen_2_label_1, 150, 40);
    ...
    lv_obj_set_style_text_font(ui->screen_2_label_1, &lv_font_ZiTiQuanWeiJunHeiW22_30, LV_PART_MAIN|LV_STATE_DEFAULT);

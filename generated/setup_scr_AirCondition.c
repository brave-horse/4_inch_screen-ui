...
void setup_scr_AirCondition(lv_ui *ui)
{
    ...
    ui->AirCondition_tabview_1 = lv_tabview_create(ui->AirCondition, LV_DIR_TOP, 70);
    ...
    lv_style_set_bg_color(&style_AirCondition_tabview_1_extra_btnm_main_default, lv_color_hex(0x4f3f3f));
    ...
    lv_obj_set_pos(ui->AirCondition_cont_1, 0, 71);
    lv_obj_set_size(ui->AirCondition_cont_1, 720, 645);
    ...
    lv_obj_set_pos(ui->AirCondition_FabCurtianLeft, 194, 111);
    ...
    lv_obj_set_pos(ui->AirCondition_AcSpd3, 185, 240);
    ...
    lv_obj_set_pos(ui->AirCondition_AcSpd2, 185, 240);
    ...
    lv_obj_set_pos(ui->AirCondition_AcSpd1, 185, 240);

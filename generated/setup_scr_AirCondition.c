...
void setup_scr_AirCondition(lv_ui *ui)
{
    ...
    lv_obj_set_pos(ui->AirCondition_btn_1, 40, 25);
    lv_obj_set_size(ui->AirCondition_btn_1, 92, 34);
    ...
    lv_obj_set_pos(ui->AirCondition_btn_2, 4, 4);
    lv_obj_set_size(ui->AirCondition_btn_2, 229, 82);

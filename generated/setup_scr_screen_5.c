...
void setup_scr_screen_5(lv_ui *ui)
{
    ...
    lv_obj_set_pos(ui->screen_5_label_2, 260, 571);
    lv_obj_set_size(ui->screen_5_label_2, 209, 31);
    ...
    lv_obj_set_pos(ui->screen_5_label_1, 239, 405);
    ...
    lv_obj_set_pos(ui->screen_5_CT_on_off_2_img, 21, 86);
    ...
    lv_obj_set_pos(ui->screen_5_imgbtn_1, 634, 91);
    ...
    lv_label_set_text(ui->screen_5_btn_1_label, "Button");
    ...
    lv_obj_set_pos(ui->screen_5_btn_1, 66, 10);
    lv_obj_set_size(ui->screen_5_btn_1, 100, 50);

...
void setup_scr_MagLight(lv_ui *ui)
{
    ...
    lv_obj_set_size(ui->MagLight_ct_bar, 650, 70);
    ...
    lv_obj_set_size(ui->MagLight_slider_2, 650, 70);
    ...
    lv_obj_set_size(ui->MagLight_slider_1, 650, 70);
    ...
    lv_obj_set_pos(ui->MagLight_imgbtn_1, 624, 95);
...
#if LV_USE_GUIDER_SIMULATOR
    lv_img_set_src(ui->MagLight_Orange, "D:\\7.NXP-GUI-PROJECT\\4_inch_screen\\import\\image\\MagOrg.png");
#else
...
#if LV_USE_GUIDER_SIMULATOR
    lv_img_set_src(ui->MagLight_white, "D:\\7.NXP-GUI-PROJECT\\4_inch_screen\\import\\image\\MagWhi.png");
#else

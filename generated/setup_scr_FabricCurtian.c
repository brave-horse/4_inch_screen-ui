...
void setup_scr_FabricCurtian(lv_ui *ui)
{
    ...
    lv_obj_set_pos(ui->FabricCurtian_btn_1, 40, 25);
    ...
    lv_obj_set_size(ui->FabricCurtian_label_1, 63, 24);
    ...
    lv_obj_set_style_text_font(ui->FabricCurtian_label_1, &lv_font_ZiTiQuanWeiJunHeiW22_24, LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    lv_obj_set_pos(ui->FabricCurtian_btn_2, 4, 4);
    lv_obj_set_size(ui->FabricCurtian_btn_2, 229, 82);

...
void setup_scr_LedStrip(lv_ui *ui)
{
    ...
    ui->LedStrip_tabview_1 = lv_tabview_create(ui->LedStrip, LV_DIR_TOP, 70);
    ...
    lv_obj_set_style_border_width(ui->LedStrip_cont_1, 2, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_border_opa(ui->LedStrip_cont_1, 255, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_border_color(ui->LedStrip_cont_1, lv_color_hex(0x2195f6), LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_border_side(ui->LedStrip_cont_1, LV_BORDER_SIDE_FULL, LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    lv_obj_set_style_text_font(ui->LedStrip_label_2, &lv_font_ZiTiQuanWeiJunHeiW22_30, LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    lv_img_set_src(ui->LedStrip_ct_bar, "D:\\7.NXP-GUI-PROJECT\\4_inch_screen\\import\\image\\ct_bar.png");
#else
    ...
    lv_obj_set_size(ui->LedStrip_ct_bar, 600, 70);
    ...
    lv_obj_set_size(ui->LedStrip_slider_2, 600, 70);
    ...
    lv_obj_set_size(ui->LedStrip_slider_1, 600, 70);
    ...
    lv_obj_set_style_text_font(ui->LedStrip_label_1, &lv_font_ZiTiQuanWeiJunHeiW22_30, LV_PART_MAIN|LV_STATE_DEFAULT);
...
#if LV_USE_GUIDER_SIMULATOR
    lv_imgbtn_set_src(ui->LedStrip_imgbtn_1, LV_IMGBTN_STATE_RELEASED, NULL, "D:\\7.NXP-GUI-PROJECT\\4_inch_screen\\import\\image\\scene_btn.png", NULL);
    lv_imgbtn_set_src(ui->LedStrip_imgbtn_1, LV_IMGBTN_STATE_CHECKED_RELEASED, NULL, "D:\\7.NXP-GUI-PROJECT\\4_inch_screen\\import\\image\\btn_close.png", NULL);
#else
    ...
    lv_obj_set_pos(ui->LedStrip_imgbtn_1, 652, 101);
    lv_obj_set_size(ui->LedStrip_imgbtn_1, 48, 48);
...
#if LV_USE_GUIDER_SIMULATOR
    lv_imgbtn_set_src(ui->LedStrip_on_off_2_img, LV_IMGBTN_STATE_RELEASED, NULL, "D:\\7.NXP-GUI-PROJECT\\4_inch_screen\\import\\image\\onoff_off.png", NULL);
    lv_imgbtn_set_src(ui->LedStrip_on_off_2_img, LV_IMGBTN_STATE_CHECKED_RELEASED, NULL, "D:\\7.NXP-GUI-PROJECT\\4_inch_screen\\import\\image\\onoff_on.png", NULL);
#else
    ...
    lv_obj_set_pos(ui->LedStrip_on_off_2_img, 20, 101);
    ...
    lv_img_set_src(ui->LedStrip_LSOn, &_sLedStripOn_alpha_300x196);
    ...
    lv_img_set_src(ui->LedStrip_LSOff, &_sLedStripOff_alpha_300x196);

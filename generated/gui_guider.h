...
typedef struct
{
	...
	lv_obj_t *LightCT;
	bool LightCT_del;
	lv_obj_t *LightCT_tabview_1;
	lv_obj_t *LightCT_tabview_1_tab_1;
	lv_obj_t *LightCT_cont_1;
	lv_obj_t *LightCT_label_2;
	lv_obj_t *LightCT_ct_bar;
	lv_obj_t *LightCT_slider_2;
	lv_obj_t *LightCT_slider_1;
	lv_obj_t *LightCT_label_1;
	lv_obj_t *LightCT_dev_shell_img;
	lv_obj_t *LightCT_white_lid;
	lv_obj_t *LightCT_dev_orange_img;
	lv_obj_t *LightCT_dev_white_img;
	lv_obj_t *LightCT_imgbtn_1;
	lv_obj_t *LightCT_imgbtn_1_label;
	lv_obj_t *LightCT_btn_1;
	lv_obj_t *LightCT_btn_1_label;
	lv_obj_t *LightCT_on_off_2_img;
	lv_obj_t *LightCT_on_off_2_img_label;
	lv_obj_t *LedStrip;
	bool LedStrip_del;
	...
	lv_obj_t *screen_1_RollBlindPole;
}lv_ui;
...
LV_IMG_DECLARE(_sClose_alpha_60x60);
LV_IMG_DECLARE(_sOpen_alpha_60x60);
LV_IMG_DECLARE(_sOpen_alpha_60x60);
LV_IMG_DECLARE(_sClose_alpha_60x60);
LV_IMG_DECLARE(_sDown_alpha_60x60);
LV_IMG_DECLARE(_sUp_alpha_60x60);
LV_IMG_DECLARE(_sClose_alpha_54x60);
LV_IMG_DECLARE(_sOpen_alpha_60x60);
...
LV_IMG_DECLARE(_sLedStripOn_alpha_65x43);
LV_IMG_DECLARE(_sLedStripOff_alpha_65x43);
LV_IMG_DECLARE(_sLedStripOn_alpha_300x196);
LV_IMG_DECLARE(_sLedStripOff_alpha_300x196);
LV_IMG_DECLARE(_MagOrg_alpha_453x13);
LV_IMG_DECLARE(_MagWhi_alpha_453x13);
LV_IMG_DECLARE(_RGBCover_alpha_196x190);
LV_IMG_DECLARE(_RGBblue_alpha_537x170);
LV_IMG_DECLARE(_RGBRed_alpha_537x170);
LV_IMG_DECLARE(_RGBGreen_alpha_537x170);
LV_IMG_DECLARE(_FabCurtianOpen_alpha_94x95);
LV_IMG_DECLARE(_FabCurtianClose_alpha_95x95);
...
LV_IMG_DECLARE(_FabCurtianright_alpha_231x287);
LV_IMG_DECLARE(_FabCurtianright_alpha_231x287);
LV_IMG_DECLARE(_FabCurtianPull_alpha_45x45);
LV_IMG_DECLARE(_FabCurtianPull_alpha_45x45);
LV_IMG_DECLARE(_FabCurtianPole_alpha_494x34);
LV_IMG_DECLARE(_FabCurtianOpen_alpha_94x95);
LV_IMG_DECLARE(_FabCurtianClose_alpha_95x95);
LV_IMG_DECLARE(_FabCurtianPause_alpha_109x110);
LV_IMG_DECLARE(_FabCurtianBg1_alpha_62x60);
LV_IMG_DECLARE(_FabCurtianBg3_alpha_42x14);
LV_IMG_DECLARE(_FabCurtianBg2_alpha_34x73);
LV_IMG_DECLARE(_SheersLeft_alpha_231x287);
LV_IMG_DECLARE(_SheersRight_alpha_231x287);
LV_IMG_DECLARE(_FabCurtianPull_alpha_45x45);
LV_IMG_DECLARE(_FabCurtianPull_alpha_45x45);
LV_IMG_DECLARE(_FabCurtianPole_alpha_494x34);
...
LV_IMG_DECLARE(_FabCurtianBg3_alpha_42x14);
LV_IMG_DECLARE(_FabCurtianBg2_alpha_34x73);
LV_IMG_DECLARE(_DreamLeft_alpha_230x249);
LV_IMG_DECLARE(_DreamRight_alpha_230x249);
LV_IMG_DECLARE(_FabCurtianPull_alpha_45x45);
LV_IMG_DECLARE(_FabCurtianPull_alpha_45x45);
LV_IMG_DECLARE(_FabCurtianPole_alpha_494x34);
LV_IMG_DECLARE(_ACDry_alpha_109x109);
LV_IMG_DECLARE(_ACSpeedAuto_alpha_109x109);
LV_IMG_DECLARE(_AirConditionImg_alpha_332x140);
LV_IMG_DECLARE(_AcSpd1_alpha_349x94);
LV_IMG_DECLARE(_ACOff_alpha_109x109);
LV_IMG_DECLARE(_ACOn_alpha_109x109);
LV_IMG_DECLARE(_ACSpeed1_alpha_109x109);
LV_IMG_DECLARE(_ACSpeed2_alpha_109x109);
LV_IMG_DECLARE(_ACSpeed3_alpha_109x109);
LV_IMG_DECLARE(_ACSpeed4_alpha_109x109);
LV_IMG_DECLARE(_AcCool_alpha_109x109);
LV_IMG_DECLARE(_ACFan_alpha_109x109);
LV_IMG_DECLARE(_ACHot_alpha_109x109);
LV_IMG_DECLARE(_AcSpd2_alpha_349x94);
LV_IMG_DECLARE(_AcSpd3_alpha_349x94);
LV_IMG_DECLARE(_RollBlindUp_alpha_94x95);
LV_IMG_DECLARE(_RollBlindDown_alpha_94x95);
LV_IMG_DECLARE(_FabCurtianPause_alpha_109x110);
LV_IMG_DECLARE(_FabCurtianBg1_alpha_62x60);
...
LV_IMG_DECLARE(_RollBlindUp_alpha_94x95);
LV_IMG_DECLARE(_RollBlindDown_alpha_94x95);
LV_IMG_DECLARE(_DRPause_alpha_109x109);
LV_IMG_DECLARE(_DryRackTop_alpha_272x26);
LV_IMG_DECLARE(_DryRackPole_alpha_405x319);
LV_IMG_DECLARE(_DRLightOff_alpha_109x109);
LV_IMG_DECLARE(_DRLightOn_alpha_109x109);
LV_IMG_DECLARE(_RollBlindUp_alpha_94x95);
LV_IMG_DECLARE(_RollBlindDown_alpha_94x95);
LV_IMG_DECLARE(_FabCurtianPause_alpha_109x110);
LV_IMG_DECLARE(_FabCurtianBg1_alpha_62x60);

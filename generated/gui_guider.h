...
typedef struct
{
	...
	lv_obj_t *FabricCurtian_imgbtn_1;
	lv_obj_t *FabricCurtian_imgbtn_1_label;
	lv_obj_t *FabricCurtian_btn_1;
	lv_obj_t *FabricCurtian_btn_1_label;
	lv_obj_t *FabricCurtian_on_off_2_img;
	lv_obj_t *FabricCurtian_on_off_2_img_label;
	...
	lv_obj_t *Sheers_imgbtn_1;
	lv_obj_t *Sheers_imgbtn_1_label;
	lv_obj_t *Sheers_btn_1;
	lv_obj_t *Sheers_btn_1_label;
	lv_obj_t *Sheers_on_off_2_img;
	lv_obj_t *Sheers_on_off_2_img_label;
